class Advertisement < ActiveRecord::Base
  ...
  ADV_TYPES_SHOW = '{"featured_venue": "Featured Venue", "featured_event": "Featured Event", "featured_artist": "Featured Artist", "banner_ads": "Advertisement - Banner", "details_ads": "Advertisement - Details"}'
  ADV_PLACEMENTS = {
