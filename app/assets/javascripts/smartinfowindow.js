...
SmartInfoWindow.prototype.draw = function() {
  ...
  switch (alignment) {
    ...
    case SmartInfoWindow.Align.BELOW:
      ...
      this.offsetX_ = -(this.width_ / 2 - 17) + 255;
      this.offsetY_ = -15 + 130;
      paddingTop = 20;
      break;
  ...
  this.div_.style.background = 'url("assets/' + image + '")';
...
SmartInfoWindow.prototype.createElement = function() {
  ...
  if (!div) {
    ...
    div.className = 'infobox infobox_' + infobox_number;
    ...
    // closeImg.src = '/assets/closebigger.gif';
    ...
    // ** Removed this and above closeImg stuff because no [x] button is needed since we're hiding on mouse out.
...
SmartInfoWindow.prototype.getBestAlignment = function() {
  ...
  var bestAlignment = SmartInfoWindow.Align.BELOW;
