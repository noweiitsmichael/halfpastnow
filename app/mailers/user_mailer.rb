class UserMailer < ActionMailer::Base
  ...
  def uber_email(user)
    ...
    @url  = "http://www.uber.com/go/hpnatx"
    mail(:to => @user.email, :subject => "Get free rides during SXSW with Uber!", :from => "Half Past Now <support@halfpastnow.com>")
  end
